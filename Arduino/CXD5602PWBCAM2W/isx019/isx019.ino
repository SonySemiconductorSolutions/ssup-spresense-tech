...
void setup()
{
  ...
  isx019_app = isx019_appClass::getInstance();
  isx019_app->initialize(3);
...
void loop()
{
  sleep(isx019_app->get_interval()); /* wait for one second to take still picture. */
