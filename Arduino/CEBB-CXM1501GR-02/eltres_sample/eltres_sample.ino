...
void create_payload(int count) {
  ...
  switch ( number ) {
    case 0:
      // 温度設定       
      sensor_app->set_temputrue(temperature, ptr);
      break;
    case 1:
      // 気圧設定 
      sensor_app->set_pressure(pressure, ptr);
      break;
    case 2:
      // GPS設定
...
//  Serial.begin(115200);
  ...
  sensor_app->initialize(3);      //set every 3 senconds to get data
